    ...
    <div class="container main">
        ...
        <form class="form-horizontal" method="POST" action="{{ action('Shared\ProfileController@update', $user->id) }}"  enctype="multipart/form-data">
            ...
            @else
                ...
                <div class="form-row mt-2 mb-2">
                    ...
                    <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }} col-md-6">
                        ...
                        <input id="mobile" type="text" class="form-control" name="mobile" value="{{ (old('mobile')) ? old('mobile') : $user->mobile_number }}" required>
            ...
            <div class="form-group{{ $errors->has('company_name') ? ' has-error' : '' }} mt-2 mb-2">
                ...
                <input id="company_name" type="text" class="form-control" name="company_name" value="{{ (old('company_name')) ? old('company_name') : $user->company }}">
